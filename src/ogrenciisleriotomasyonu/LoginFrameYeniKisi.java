...
class LoginFrameYeniKisi extends JFrame implements ActionListener{
    ...
    String a,b;
    yeniKayıt p = new yeniKayıt() {};
    public LoginFrameYeniKisi(){
        ...
        this.setLayout(null);
        this.setTitle("yeni üye Penceresi");
        this.add(şifrel);
        this.add(pass);
        this.add(login1);
        this.add(id);
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==login1){
            ...
            try {
                ...
                Logger.getLogger(LoginFrameÜye.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        if(e.getSource()==back)
        {
