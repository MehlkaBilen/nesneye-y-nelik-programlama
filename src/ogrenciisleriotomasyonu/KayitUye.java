...
class KayitUye extends JFrame implements ActionListener{
    ...
    public KayitUye(){
        ...
        this.setLayout(null);
        this.setTitle("üye kayıt Penceresi");
        this.add(id);
        this.add(idl);
        this.add(pass);
        this.add(şifrel);
        ...
        if(e.getSource()==kayit){
            ...
            if(a.isEmpty()||b.isEmpty()){
                ...
                try {
                    ...
                    Logger.getLogger(KayitUye.class.getName()).log(Level.SEVERE, null, ex);
                }
                if(üye.kayıt){
