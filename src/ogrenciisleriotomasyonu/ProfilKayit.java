...
import static ogrenciisleriotomasyonu.yeniKayıt.i;
import static ogrenciisleriotomasyonu.yeniKayıt.isimler;
import static ogrenciisleriotomasyonu.yeniKayıt.soyisimler;


class ProfilKayit extends JFrame implements ActionListener{
    ...
    ProfilKayit(){
        ...
        this.setLayout(null);
        this.setTitle("kayıt Profil Penceresi");
        this.add(id);
        this.add(isim);
        this.add(soyisim);
        this.add(idtxt);
