...
import static ogrenciisleriotomasyonu.yeniKayıt.idler;


class yeniKayıt extends kişi implements User{
    static int i = 0;
    ...
    static File idfile = new File("yeni kişi ID.txt");
    static File şifrefile = new File("yeni kişi Şifre.txt");
    static File isimfile = new File("yeni kişi İsim.txt");
    static File soyisimfile = new File("yeni kişi Soyisim.txt");
    static String z = "\n";
    
    @Override
    public boolean giriş(String a, String b) throws IOException{
        BufferedReader br = new BufferedReader(new FileReader("yeni kişi ID.txt"));
        BufferedReader br1 = new BufferedReader(new FileReader("yeni kişi Şifre.txt"));
        BufferedReader br2 = new BufferedReader(new FileReader("yeni kişi İsim.txt"));
        BufferedReader br3 = new BufferedReader(new FileReader("yeni kişi Soyisim.txt"));
